...
class Container_8f7da88412 extends _PHPStan_c161e9ff7\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0446(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8f7da88412 $container)
			{
	...
	public function createServiceContainer(): Container_8f7da88412
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'TERM_SESSION_ID' => 'd82dcf1d-b4a9-4c7b-b86c-787b90c249ec',
