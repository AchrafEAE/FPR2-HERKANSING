...
class Container_aeb4c9b6ba extends _PHPStan_c161e9ff7\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0446(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_aeb4c9b6ba $container)
			{
	...
	public function createServiceContainer(): Container_aeb4c9b6ba
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 8,
			'paths' => ['C:\Visual-studio-project-folder\FPR2 HERKANSING\app'],
			'exceptions' => [
				'implicitThrows' => true,
