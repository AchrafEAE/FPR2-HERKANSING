...
class Container_6861c0d8ed extends _PHPStan_c161e9ff7\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0446(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_6861c0d8ed $container)
			{
	...
	public function createServiceContainer(): Container_6861c0d8ed
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'TERM_SESSION_ID' => '04e05f7a-6969-4f26-8fb3-4e6bfca842d8',
