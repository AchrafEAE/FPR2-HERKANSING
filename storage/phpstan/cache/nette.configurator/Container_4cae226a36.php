...
class Container_4cae226a36 extends _PHPStan_c161e9ff7\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0446(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_4cae226a36 $container)
			{
	...
	public function createServiceContainer(): Container_4cae226a36
	{
		return $this;
	}
