...
class Container_ac802cd27f extends _PHPStan_c161e9ff7\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0446(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ac802cd27f $container)
			{
	...
	public function createServiceContainer(): Container_ac802cd27f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'TERM_SESSION_ID' => '6b830c97-117b-4782-9f88-399aa47482f4',
